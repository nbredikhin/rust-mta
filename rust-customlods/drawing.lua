lodsDrawing = {}
lodsDrawing.material = dxCreateTexture("images/lod.png")
lodsDrawing.material_door = dxCreateTexture("images/lod_door.png")
lodsDrawing.material_window = dxCreateTexture("images/lod_window.png")
...
drawFunctions["foundation"] = function(x, y, z, rotation, color)
	drawBox(lodsDrawing.material, lodsDrawing.material, x, y, z - ModelsSizes.foundation.height / 2, ModelsSizes.foundation.width, ModelsSizes.foundation.width, ModelsSizes.foundation.height, rotation, color)
end

drawFunctions["wall"] = function(x, y, z, rotation, color)
	drawBox(lodsDrawing.material, lodsDrawing.material, x, y, z + ModelsSizes.wall.height / 2, ModelsSizes.wall.width, ModelsSizes.wall.depth, ModelsSizes.wall.height, rotation, color)
end

drawFunctions["wall_door"] = function(x, y, z, rotation, color)
	drawBox(lodsDrawing.material, lodsDrawing.material_door, x, y, z + ModelsSizes.wall.height / 2, ModelsSizes.wall.width, ModelsSizes.wall.depth, ModelsSizes.wall.height, rotation, color)
end

drawFunctions["wall_window"] = function(x, y, z, rotation,color)
	drawBox(lodsDrawing.material, lodsDrawing.material_window, x, y, z + ModelsSizes.wall.height / 2, ModelsSizes.wall.width, ModelsSizes.wall.depth, ModelsSizes.wall.height, rotation, color)
end

drawFunctions["floor"] = function(x, y, z, rotation, color)
	drawBox(lodsDrawing.material, lodsDrawing.material, x, y, z, ModelsSizes.floor.width, ModelsSizes.floor.width, ModelsSizes.floor.height, rotation, color)
end

function lodsDrawing:drawObject(name, ...)
